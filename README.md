...
![Version](https://img.shields.io/badge/version-2.1.3-blue.svg?style=flat-square) ![License](https://img.shields.io/badge/license-MIT-green.svg?style=flat-square) ![ShellCheck](https://img.shields.io/badge/ShellCheck-passing-brightgreen?style=flat-square)
...
Version 2.1.3 (Task Tags & Shell Completion). Zero config, Zero dependencies. Runs on Linux and macOS.
...
- Recommended hash for v2.1.3: 0f7f95639098469eacf751dee2277923ceefdcbf4cfadc693955fccaf553b1e3
...
Version 2.1.3 (Task-Tags & Shell-Completion). Zero Config, Zero Dependencies. Läuft auf Linux und macOS.
